  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative rounded-2xl bg-gradient-to-b from-[#14110F] to-[#0D0B0A] border border-[#26201B] hover:border-[#D4AF37]/40 p-8 sm:p-10 shadow-xl transition-colors duration-300 cursor-default h-full"
      >
        {/* Dynamic cursor glow */}
        <motion.div
          ...
          style={{
            background: useTransform(
              [glowX, glowY],
              ([x, y]) =>
                `radial-gradient(circle at ${x}% ${y}%, rgba(212,175,55,0.14) 0%, transparent 65%)`
            ),
          }}
        />
        ...
        >
          <div>
            <div className="w-12 h-12 rounded-xl bg-[#1A1613] border border-[#2E2824] flex items-center justify-center mb-8 group-hover:scale-105 group-hover:border-[#D4AF37]/50 transition-all duration-300">
          ...
          <div className="mt-8 pt-6 border-t border-[#1F1B18] flex items-center justify-between text-xs">
