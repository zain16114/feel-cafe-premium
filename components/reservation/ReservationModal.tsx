            ...
            {!submitted ? (
              <>
                <div className="mb-6">
                  ...
                  <p className="mt-2 text-xs sm:text-sm text-[#9E938A] leading-relaxed">
                    Submit your reservation details below, or call our team directly at{" "}
                    <button
                      type="button"
                      onClick={handleCall}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-3">
                    <button
                      type="submit"
                      className="w-full py-3.5 text-xs font-semibold uppercase tracking-[0.2em] rounded-full bg-gradient-to-r from-[#D4AF37] to-[#E8C86A] text-[#080706] shadow-lg shadow-[#D4AF37]/20 hover:brightness-110 active:scale-[0.99] transition-all cursor-pointer"
                    >
                      Confirm Inquiry
                    </button>
                  </div>
              ...
              <div className="py-8 text-center space-y-4">
                ...
                <p className="text-sm text-[#9E938A] max-w-sm mx-auto leading-relaxed">
                  Thank you, <strong className="text-[#F4EDE4]">{name}</strong>. Your request for {guests} on {date} at {time} has been logged. Our cafe team will confirm via {phone}.
                </p>
                <div className="pt-4">
                  <button
                    onClick={onClose}
